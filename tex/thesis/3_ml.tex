...
\label{sec:crowd-labels}
    ...
    In crowd learning scenarios, it is common to have multiple labels for a
    data point with no known groundtruth.
...
<<<<<<< HEAD
                ...
                \caption{Performance of the \citeauthor{raykar10} classifier against
                    logistic regression (LR) on a simulated crowd labelling of the breast
...
>>>>>>> c122024c648b71efb51714a8193cf1b71f95b25a
                \label{fig:raykar}
            \end{figure}
        ...
        \subsubsection{The Effect of Label Noise}
            ...
            $\beta$ replacing $\alpha$. The results are shown in Figure \ref{fig:raykar-noise}.
