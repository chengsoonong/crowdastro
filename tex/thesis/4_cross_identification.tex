...
\label{sec:rgz-results}
  ...
  \label{sec:comparison-predictors}
    ...
    % The classifier was then used to classify the objects in the testing set.
    % The labels were compared to those found by \citet{norris06} as described
    % in Section \ref{sec:norris}, resulting in $80.14\%$ balanced accuracy.
