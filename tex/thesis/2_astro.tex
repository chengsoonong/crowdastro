...
\label{cha:astro}
    ...
    galactic nuclei. In this section, we describe what we see in radio and
    infrared surveys, as well as introducing specific radio and infrared surveys
    relevant to this thesis. We also discuss the motivation behind
    cross-identifying active galactic nuclei with their host galaxies, as well
    as the inherent difficulty in doing so, and hence provide the motivation for
    this thesis.
    ...
    \label{sec:agns}
        ...
        \begin{figure}
            ...
            \caption{An image of a radio AGN taken by the NRAO Very Large Array,
                centred on FIRSTJ093244.5+161050.}
        \end{figure}

        We can observe the jets of radio AGNs with radio telescopes.
