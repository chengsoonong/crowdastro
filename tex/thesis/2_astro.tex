    ...
    \label{sec:infrared-surveys}
        ...
        \label{sec:wise}
            ...
            \begin{figure}[!ht]
                \centering
                \includegraphics[width=0.5\textwidth]
                    {images/WISE_J032836.51-284155.9_20arcmin.png}
                \caption{WISE multi-wavelength composite image centred on
                    3m28h36.51s -28d41m55.9s, the location of an AGN in the CDFS
                    field.}
            \end{figure}
            ...
            described in detail by \citeauthor{wright10}.
