...
\label{cha:astro}
    ...
    \label{sec:radio-cross-identification}
        ...
        \label{sec:norris}
            ...
            Along with a catalogue of radio objects found in the CDFS field by the ATLAS survey, \citetitle{norris06} produced a catalogue of cross-identifications of these radio objects. 
