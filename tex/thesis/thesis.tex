...
% Windows but not on Mac (where Palatino exists instead). So... we'll come back
% to this once we begin the document.
\def\myfontlist{Palatino Linotype, Palatino}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Font setup.
% This has to be done from the document, or the font isn't loaded yet.
% http://tex.stackexchange.com/a/53461/46613
\makeatletter
...
\@for\next:=\myfontlist\do{%
    \expandafter\newfontfamily\csname\next\endcsname{\next}
    \setbox0=\hbox{\csname\next\endcsname A}
    \ifdim\ht0=0pt\else\setmainfont{\next}\\\fi
 }
