...
\label{sec:query-strategies}
    ...
    \label{sec:qbc}
        ...
        label, and the data point with the most disagreement is queried. The
        intuition is that if a data point is hard to classify, then the
        committee will disagree on it, and it will be useful to know the true
        label.
