...
galaxies --- around 30 times the number of radio galaxies we know about today
...
\label{sec:outline}
  ...
  Chapter \ref{cha:cross-identification} brings together Chapters
  \ref{cha:astro} and \ref{cha:ml} to develop a machine learning approach to the
  radio cross-identification task. We formalise the problem, highlight the
  problems that must be solved for development, trial different methods of
  approaching the task, and present results on task performance using our
  classifier.
...
\label{sec:data-products}
  ...
  Learning Repository \footnote{\url{https://archive.ics.uci.edu/ml/}}.
  ...
  for astronomy, and scikit-learn \citep{scikit-learn}, an open source machine
  learning package.
