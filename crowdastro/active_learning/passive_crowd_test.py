...
class TestTrain(unittest.TestCase):
    ...
    def test_train(self):
        ...
        self.assertTrue(numpy.allclose(
            a,
            numpy.array([
                 1.76405235,  0.57005738,  1.31853832,  2.75059371,  2.54715867,
                -0.12777703,  1.96948944,  1.03794398,  1.25598251,  1.93970003,
            ])))

        self.assertTrue(numpy.isclose(b, 1.6731451023632251))

        self.assertTrue(numpy.allclose(
            w,
            numpy.array([
                [ 0.        , 0.19899859, 0.39799718, 0.59699577, 0.79599436,
                  0.99499295, 1.19399153, 1.39299012, 1.59198871, 1.7909873 ],
                [ 0.        , 0.19899859, 0.39799718, 0.59699577, 0.79599436,
                  0.99499295, 1.19399153, 1.39299012, 1.59198871, 1.7909873 ],
                [ 0.        , 0.19899859, 0.39799718, 0.59699577, 0.79599436,
                  0.99499295, 1.19399153, 1.39299012, 1.59198871, 1.7909873 ],
        ...
        self.assertTrue(numpy.allclose(
            g,
            numpy.array(
                [ 2.7909873,  2.7909873,  2.7909873,  2.7909873,  2.7909873])))
