...
class StratifiedSampler(RandomSampler):
    """Pool-based learning with stratified random sampling.
    ...
    def sample_index(self):
        ...
        if len(unlabelled):
            positive_pc = unlabelled_groundtruth.mean()
            if numpy.random.random() < positive_pc:
